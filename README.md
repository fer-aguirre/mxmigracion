# MXmigracion
MXmigracion es una librería para interactuar fácilmente con los datos de la Unidad de Política Migratoria, Registro e Identidad de Personas (UPMRIP) desde Python.
